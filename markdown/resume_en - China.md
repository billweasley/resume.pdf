...
<li> Evaluated the performance of the speech recognition system, seeking the most suitable parameters to reduce real-time factors or improve system throughput.</li>
</ul>
</small></description>
