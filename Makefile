...
all: pdf/Haoxuan_Wang_resume_cn.pdf pdf/Haoxuan_Wang_resume_en_China.pdf pdf/Haoxuan_Wang_resume_en_Zoom.pdf
...
pdf/Haoxuan_Wang_resume_en_Zoom.pdf: markdown/resume_en_zoom.md Makefile
	md2pdf markdown/resume_en_zoom.md -s css/style.css -o html/resume_en_zoom.html
	xvfb-run -a -- /usr/bin/wkhtmltopdf --zoom 0.2 'html/resume_en_zoom.html' 'pdf/Haoxuan_Wang_resume_en_zoom.pdf'
