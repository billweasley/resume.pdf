...
all: pdf/Haoxuan_Wang_resume_cn.pdf pdf/Haoxuan_Wang_resume_en.pdf pdf/Haoxuan_Wang_resume_en_China.pdf
...
pdf/Haoxuan_Wang_resume_en_China.pdf: markdown/resume_en\ -\ China.md Makefile
	...
	xvfb-run -a -- /usr/bin/wkhtmltopdf --zoom 0.3 'html/resume_en_China.html' 'pdf/Haoxuan_Wang_resume_en_China.pdf'
